/* ── KEEP: THE BENCH SAVES ITSELF AS THE DEFAULT LOOK ──────────────────────
   ...
   knoll-toem2:pos:<gizmo> and frames.js keeps re-cut sizes in
   knoll-toem2:size2:<gizmo>, and both of those are IN THIS BROWSER — they are
  ...
  async function push(force, hand) {
    ...
    try {
      ...
      window.Lab.gizmos.forEach(g => {
        ...
        try { localStorage.removeItem('knoll-toem2:pos:' + id); localStorage.removeItem('knoll-toem2:z:' + id); } catch (e) {}
      });
