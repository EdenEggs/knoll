...
window.Stickers = (function () {
  ...
  function wireDrag(box) {
    ...
    const end = e => {
      ...
      // over the paper, and not over the drawer itself. The yard has no #bench:
      // its paper is the whole page (.yard-root) and the wall laid over it (2026-09-21)
      const t = document.elementFromPoint(e.clientX, e.clientY);
      if (!t || t.closest('#stickers') || !t.closest('#bench, #bench-world, .yard-root')) {
