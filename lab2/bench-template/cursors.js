...
window.Company = (function () {
  ...
  /* ONE ROOM PER BENCH, which used to be one per host and cannot be any
     more: this bench and lab 2 are served off the same host, and a room
  ...
  const ROOM  = (location.host || 'nowhere') + '/@@BENCH_KEY@@';
