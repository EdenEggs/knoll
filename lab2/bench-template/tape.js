...
window.Tape = (function () {
  ...
  const store = Lab.store('tape', () => ({
    /* NO STRIP TO START WITH, on a bench made from lab2/bench-template. Lab 2
       parks one in the gutter between its first two rows of features, at world
       60–700 × ~1100, which on a bench of its own would lie across whatever was
       put there first. The dock's tape button still strings one across the
