...
window.Frames = (function () {
  ...
  /* …under the page's own prefix when the page has one. A game page and the
     bench share an origin, so lab.js keeps every key under data-lab-page
     (PAGE-SCOPED STORES, there) and hands the prefix out as Lab.storeKey;
     this is the one key of this file's. The literal stands behind it for a
     lab.js from before storeKey existed. */
  const KEY = (window.Lab && Lab.storeKey) ? Lab.storeKey('size2:') : 'knoll-lab2:size2:';
